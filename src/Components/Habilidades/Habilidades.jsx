  ...
  return (
    <Container fluid className="Habilidades_Container">
      ...
      <Row >
        ...
        <Col sm={12} xl={12}>
        <p className="Habilidades_Descripcion_SobreMi">   ¡Hola! 👋 Soy Liam Marega soy residente de Argentina y actual Full Stack
            Developer con experiencia en el bootcamp de SoyHenry.
            Manejo todo el Stack Mern de JavaScript y me adapto con facilidad al
            uso de nuevas tecnologías y me adapto muy rapido a entornos nuevos. 😊</p>
        </Col>
      </Row>
