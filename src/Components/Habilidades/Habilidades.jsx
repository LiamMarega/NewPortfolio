    ...
    <Container fluid className="Habilidades_Container">
      <Container className="Habilidades_ContainerHijo">
        ...
        <Row>
          ...
          <Col sm={12} xl={12}>
            <p className="Habilidades_Descripcion_SobreMi">
              {" "}
              ¡Hola! 👋 Soy Liam Marega, actual Full Stack Developer con
              diferentes experienciaa institucionales y laborales. <br /> Manejo
              todo el Stack Mern de JavaScript, me adapto con facilidad al uso
              de nuevas tecnologías y a entornos nuevos. 😊
            </p>
          </Col>
        </Row>
